    ...
    >
      <div className="dark:text-white px-10 py-7">
        <div className="flex flex-row text-[30px] gap-10 justify-between items-center">
          <Link href={"/"} className="font-bold xs:hidden" data-aos="zoom-in">
            Hari Nair
          </Link>
          <Link
            href={"/"}
            className="font-bold hidden xs:contents"
            data-aos="zoom-in"
          >
            HN
          </Link>
          <div id="items" className="flex flex-row gap-10">
            <div
              className="text-[25px] item sm:hidden xs:hidden"
              data-aos="zoom-in"
            >
        ...
        {tog && (
          <div className="hidden xs:contents sm:contents">
            <div className="flex flex-col gap-10 items-end text-[20px] mt-10">
              ...
              <Link onClick={handleToggle} href={"/about"} data-aos="zoom-in">
                About
              </Link>
              <Link onClick={handleToggle} href={"/contact"} data-aos="zoom-in">
                Contact
              </Link>
            </div>
          </div>
